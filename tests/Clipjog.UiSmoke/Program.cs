...
internal static class Program
{
    ...
    private static int Main(string[] args)
    {
        ...
        // rather than by instantiating Clipjog.App.App, whose OnStartup installs a global keyboard
        ...
        var root = Path.Combine(Path.GetTempPath(), "clipjog-uismoke", Guid.NewGuid().ToString("n"));
        ...
        using (var store = new ClipStore(paths))
        {
            ...
            var settings = new ClipjogSettings();
    ...
    {
        Source = new Uri($"pack://application:,,,/Clipjog;component/{relative}", UriKind.Absolute),
    };
