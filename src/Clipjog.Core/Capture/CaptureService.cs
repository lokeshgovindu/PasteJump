...
public sealed class CaptureService
{
    ...
    private readonly Func<ClipjogSettings> _settings;
    ...
    private void Capture(int attempt)
    {
        ...
        if (!settings.AllowDuplicateClips && IsConsecutiveDuplicate(snapshot))
        {
            ...
            // from Clipjog having missed the copy altogether, which is the more alarming reading.
