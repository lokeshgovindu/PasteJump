...
/// <summary>
/// Loads and saves <see cref="ClipjogSettings"/> as JSON.
/// <para>
...
public sealed class SettingsStore
{
    ...
    public ClipjogSettings Load()
    {
        ...
        try
        {
            ...
            var settings = JsonSerializer.Deserialize<ClipjogSettings>(json, SerializerOptions)
                ?? new ClipjogSettings();
    ...
    public void Save(ClipjogSettings settings)
    {
